...
inDataFile="../parameterFiles/"+funcName+"Params.txt"
line=""
...
def plt_dist(oneTFile):
    ...
    y0Vec=np.array(distJsonData["y0"])
    z0Vec=np.array(distJsonData["z0"])
    y1Vec=np.array(distJsonData["y1"])
